...
namespace WebAppECartDemo.Controllers
{
    public class ShoppingController : Controller
    {
        ...
        {
            listOfShoppingCartModels = Session["CartItem"] as List<ShoppingCartModel>;
            ShoppingCartModel objShoppingCartModel = listOfShoppingCartModels.Single(model => model.ItemName == name);
        ...
        //public ActionResult UpdateItem(string name, string quantity) 
        //{
        //    listOfShoppingCartModels = Session["CartItem"] as List<ShoppingCartModel>;
        //    ShoppingCartModel objShoppingCartModel = listOfShoppingCartModels.Single(model => model.ItemName == name);
        //    objShoppingCartModel.Quantity = Convert.ToInt32(quantity);
        //    objShoppingCartModel.Total = objShoppingCartModel.Quantity * objShoppingCartModel.UnitPrice;
        //    Session["CartItem"] = listOfShoppingCartModels;
        //    /*Session["CartCounter"] = listOfShoppingCartModels.Count;*/
        //    return RedirectToAction("ShoppingCart");
        ...
        [HttpPost]
        public ActionResult UpdateItem(ShoppingCartModel model)
        {
            listOfShoppingCartModels = Session["CartItem"] as List<ShoppingCartModel>;
            ShoppingCartModel objShoppingCartModel = listOfShoppingCartModels.Single(m => m.ItemName == model.ItemName);
            objShoppingCartModel.Quantity = model.Quantity;
            objShoppingCartModel.Total = objShoppingCartModel.Quantity * objShoppingCartModel.UnitPrice;
            Session["CartItem"] = listOfShoppingCartModels;
            /*Session["CartCounter"] = listOfShoppingCartModels.Count;*/
            return RedirectToAction("ShoppingCart");
